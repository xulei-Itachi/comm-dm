...
INSERT INTO "mendixsystem$association" ("id", "association_name", "table_name", "parent_entity_id", "child_entity_id", "parent_column_name", "child_column_name", "index_name") VALUES ('633731db-9584-4b9b-b29d-10e1aeddd0ca', 'Order.Order_OrderProcess', 'order$order_orderprocess', 'bd8fb853-0f08-4ec0-b646-c03ca928e197', 'e92919c7-7960-4c19-a76a-39f4427027b2', 'order$orderid', 'order$orderprocessid', 'idx_order$order_orderprocess_order$orderprocess_order$order');
UPDATE "mendixsystem$version" SET "versionnumber" = '4.2', "lastsyncdate" = '20230329 11:17:19';
